	...
	public void mouseClicked(MouseEvent arg0) {
		...
		case "Paquet":
			if ( event == MouseEvent.BUTTON1 && tuile.CodeCarte.equals("Paquet")) {
				...
				if (!retOk) msg = "Main est complète!";
		...
		default:
				...
				if(tuile.Emplacement == 5 && event == MouseEvent.BUTTON1  &&  tuile.CodeCarte.startsWith("T")) {
					...
					if (newKey == -1) msg = "Erreur d'excécution ou programme vide!";
	...
	public void mouseEntered(MouseEvent arg0) {
		...
		default:
			...
			if( tuile.Emplacement == 5 &&  tuile.CodeCarte.startsWith("T") ) {
				...
				msg += ", Clic pour exécuter le programme, clic droit pour defausser tout le programme";
