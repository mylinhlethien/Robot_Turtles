...
public class RobotTurtlesInterface implements ActionListener {
	...
	private void DessinerPanelParam() {
		...
		comboUtilisateurCourant.setEnabled(false);
	...
	public void AfficherGrille(String[][] grille, PanelGrille panel, int emplacement) {
		Image imgTuile;
		Tuile oTuile = null;
		if(emplacement==2) grille[0][0]= "Paquet";
		if(emplacement==3) grille[0][0]= "Defense";
		if(emplacement==4) grille[0][0]= "Main";
		if(emplacement==5) grille[0][0]= Partie.GetTortue(Partie.GetNumJoueurCourant());
